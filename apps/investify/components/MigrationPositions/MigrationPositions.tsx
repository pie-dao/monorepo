...
const MigratingPositions: React.FC<MigratingPositionsProps> = ({
  ...
  return (
    <div className="flex w-full flex-col pt-4 text-center">
      <div className="flex flex-col gap-y-2 h-36 pr-4 overflow-y-scroll p-2 scrollbar:w-[8px] scrollbar:bg-white scrollbar:border scrollbar:border-sub-dark scrollbar-track:bg-white scrollbar-thumb:bg-sub-light scrollbar-track:[box-shadow:inset_0_0_1px_rgba(0,0,0,0.4)] scrollbar-track:rounded-full scrollbar-thumb:rounded-full">
        {positions &&
          positions.length > 0 &&
          !loadingPositions &&
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-x-2 text-xs justify-center flex-1">
                  ...
                  <div className="flex my-auto">
                    <dt className="text-sub-dark md:hidden">{t('Amount')}:</dt>
