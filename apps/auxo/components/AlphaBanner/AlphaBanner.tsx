export const AlphaBanner: React.FC = () => {
  return (
    <section className="w-full mb-6 flex">
      <div className="flex flex-col p-[3px] bg-gradient-to-r from-secondary via-secondary to-[#0BDD91] rounded-lg w-full">
        <div className="bg-gradient-to-r from-white via-white to-background p-1 rounded-md">
          <div className="flex items-center gap-x-2">
            <h3 className="text-primary text-base font-medium flex gap-x-2 items-center">
