...
const WithdrawLock = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-y-4 flex-1">
      ...
      <button
        onClick={boostToMax}
        className="w-fit px-4 py-0.5 text-base text-secondary bg-transparent rounded-2xl ring-inset ring-1 ring-secondary enabled:hover:bg-secondary enabled:hover:text-white disabled:opacity-70 flex gap-x-2 items-center mt-auto"
      >
        <svg
