...
let TasksController = class TasksController {
    ...
    async getKpiAirdrop(blockNumber) {
        try {
...
__decorate([
    swagger_1.ApiOkResponse({ type: Object, isArray: true }),
    swagger_1.ApiNotFoundResponse(),
    swagger_1.ApiBadRequestResponse(),
    swagger_1.ApiQuery({ name: 'blockNumber', required: true }),
    common_1.Get('kpi-airdrop'),
    __param(0, common_1.Query('blockNumber')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], TasksController.prototype, "getKpiAirdrop", null);
