...
import React__default, { createContext, useContext, useLayoutEffect, useEffect, useState, useRef, useCallback, useMemo, forwardRef, createElement, cloneElement, Children, isValidElement, Fragment, useReducer, createRef } from 'react';
...
var Icon = function (_a) {
    ...
    return (React__default.createElement("svg", __assign({ viewBox: "0 0 1024 1024", xmlns: "http://www.w3.org/2000/svg", width: width, height: height, className: classNames("inline-block transform-gpu	align-middle fill-current", className) }, props),
...
function useDisposables() {
    ...
    var _a = __read(useState(disposables), 1), d = _a[0];
...
function useServerHandoffComplete() {
    var _a = __read(useState(state.serverHandoffComplete), 2), serverHandoffComplete = _a[0], setServerHandoffComplete = _a[1];
    useEffect(function () {
...
function useId() {
    ...
    var _a = __read(useState(ready ? generateId : null), 2), id = _a[0], setId = _a[1];
...
function useComputed(cb, dependencies) {
    var _a = __read(useState(cb), 2), value = _a[0], setValue = _a[1];
...
function useSyncRefs() {
    ...
    var syncRefs = useCallback(function (value) {
        var e_1, _a;
        try {
...
function OpenClosedProvider(_a) {
    ...
    return React__default.createElement(Context$1.Provider, { value: value }, children);
}
...
function useResolveButtonType(props, ref) {
    var _a = __read(useState(function () { return resolveType(props); }), 2), type = _a[0], setType = _a[1];
    useIsoMorphicEffect(function () {
...
function useOutsideClick(containers, cb) {
    var _containers = useMemo(function () {
...
// ---
var DEFAULT_NETWORKSWITCHER_TAG = Fragment;
var NetworkSwitcherRoot = forwardRefWithAs(function NetworkSwitcher(props, ref) {
    ...
    var slot = useMemo(function () { return ({
    ...
    return (React__default.createElement(NetworkSwitcherContext.Provider, { value: reducerBag },
        React__default.createElement(OpenClosedProvider, { value: match(networkSwitcherState, (_a = {},
                _a[NetworkSwitcherStates.Open] = State$1.Open,
                _a[NetworkSwitcherStates.Closed] = State$1.Closed,
                _a)) }, name != null && value != null ? (React__default.createElement(React__default.Fragment, null,
            objectToFormEntries((_b = {}, _b[name] = value, _b)).map(function (_a) {
                var _b = __read(_a, 2), name = _b[0], value = _b[1];
                return (React__default.createElement(VisuallyHidden, __assign({}, compact({
                    key: name,
                    as: "input",
                    type: "hidden",
                    hidden: true,
...
var Label = forwardRefWithAs(function Label(props, ref) {
    ...
    var handleClick = useCallback(function () { var _a; return (_a = state.buttonRef.current) === null || _a === void 0 ? void 0 : _a.focus({ preventScroll: true }); }, [state.buttonRef]);
    var slot = useMemo(function () { return ({
        open: state.networkSwitcherState === NetworkSwitcherStates.Open,
        disabled: state.disabled,
    }); }, [state]);
...
var Options = forwardRefWithAs(function Options(props, ref) {
    ...
    var handleKeyDown = useCallback(function (event) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var slot = useMemo(function () { return ({ open: state.networkSwitcherState === NetworkSwitcherStates.Open }); }, [state]);
    var propsWeControl = {
...
var Option = forwardRefWithAs(function Option(props, ref) {
    ...
    var internalOptionRef = useRef(null);
    ...
    var select = useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var e_3, error, e_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var slot = useMemo(function () { return ({ active: active, selected: selected, disabled: disabled }); }, [active, selected, disabled]);
    var propsWeControl = {
        id: id,
        ref: optionRef,
        role: "option",
...
var gnosisSafe = new SafeAppConnector();
...
function useEagerConnect() {
    ...
    var _b = __read(useState(false), 2), tried = _b[0], setTried = _b[1];
    // gnosisSafe.isSafeApp() races a timeout against postMessage, so it delays pageload if we are not in a safe app;
    // if we are not embedded in an iframe, it is not worth checking
    var _c = __read(useState(!IS_IN_IFRAME), 2), triedSafe = _c[0], setTriedSafe = _c[1];
...
var useFallBack = function () {
    var _a = useWeb3React(), active = _a.active, activate = _a.activate, chainId = _a.chainId;
    useEffect(function () {
        if (!active)
            activate(network);
...
var useConnectedWallet = function () {
    var connector = useWeb3React().connector;
    var _a = __read(useState(), 2), activatingConnector = _a[0], setActivatingConnector = _a[1];
...
var ChainAndLogo = function (_a) {
    var _b;
    var chain = _a.chain;
    return (React__default.createElement("span", { className: "h-6 w-6 block mr-2" }, logoSwitcher((_b = chain === null || chain === void 0 ? void 0 : chain.nativeCurrency) === null || _b === void 0 ? void 0 : _b.symbol)));
};
var ChainSwitcher = function (_a) {
    ...
    var availableChains = useMemo(function () {
        return filteredChainMap(allowedChains);
    }, [allowedChains]);
    var supportedChain = useMemo(function () {
        return isChainSupported(chainId)
            ? availableChains[chainId]
            : null;
    }, [chainId]);
    var _e = __read(useState(supportedChain), 2), chain = _e[0], setChain = _e[1];
    ...
    if (loading) {
        return React__default.createElement(SkeletonUI, null);
    }
    return (React__default.createElement("div", { className: classNames("w-60", className, showNetworkName ? "w-60" : "w-20") },
            ...
            return (React__default.createElement("div", { className: "relative mt-1" },
                ...
                React__default.createElement(NetworkSwitcher.Options, { as: motion.ul, animate: { opacity: open ? 1 : 0 }, transition: { duration: 0.1 }, static: true, className: "flex flex-col absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm" }, Object.entries(availableChains).map(function (_a) {
                    ...
                    return (React__default.createElement(NetworkSwitcher.Option, { key: chain.chainId, className: function (_a) {
                        ...
                        return (React__default.createElement(React__default.Fragment, null,
                            showNetworkIcon && React__default.createElement(ChainAndLogo, { chain: chain }),
                            showNetworkName && (React__default.createElement("span", { className: "block truncate ".concat(selected ? "font-medium" : "font-normal") }, chain.chainName)),
                            selected ? (React__default.createElement("span", { className: "absolute inset-y-0 left-0 flex items-center pl-3 text-amber-600" })) : null));
                    }));
                }))));
        })));
};
var SkeletonUI = function () {
    return (React__default.createElement(AnimatePresence, null,
        React__default.createElement(motion.section, { exit: { opacity: 0 } },
            React__default.createElement(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, className: "relative overflow-hidden" },
                React__default.createElement("div", { className: "w-60 h-10 bg-gray-200 rounded-lg shadow-md" }),
                React__default.createElement(motion.div, { initial: { x: -200 }, animate: { x: 400 }, transition: {
                        duration: 1.5,
                        repeat: Infinity,
                        repeatDelay: 1,
...
function useOwnerDocument() {
    ...
    return useMemo(function () { return getOwnerDocument.apply(void 0, __spreadArray([], __read(args), false)); }, __spreadArray([], __read(args), false));
}
...
function useFocusTrap(container, features, _a) {
    ...
    var restoreElement = useRef(null);
...
var ForcePortalRootContext = createContext(false);
function usePortalRoot() {
    return useContext(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
    return (React__default.createElement(ForcePortalRootContext.Provider, { value: props.force }, props.children));
}
...
var Group = forwardRefWithAs(function Group(props, ref) {
    ...
    return (React__default.createElement(PortalGroupContext.Provider, { value: target }, render({
...
var DescriptionContext = createContext(null);
...
function useDescriptions() {
    var _a = __read(useState([]), 2), descriptionIds = _a[0], setDescriptionIds = _a[1];
    return [
        ...
        useMemo(function () {
            return function DescriptionProvider(props) {
                ...
                var contextBag = useMemo(function () { return ({
                    register: register,
                    slot: props.slot,
                    name: props.name,
                    props: props.props,
                }); }, [register, props.slot, props.name, props.props]);
                return (React__default.createElement(DescriptionContext.Provider, { value: contextBag }, props.children));
            };
        }, [setDescriptionIds]),
    ];
}
...
var StackContext = createContext(function () { });
...
function StackProvider(_a) {
    ...
    return React__default.createElement(StackContext.Provider, { value: notify }, children);
}
...
function useConnectContext(component) {
    var context = useContext(ConnectContext);
    if (context === null) {
...
var ConnectRoot = forwardRefWithAs(function Connect(props, ref) {
    ...
    var _c = __read(useState(0), 2), nestedConnectCount = _c[0], setNestedConnectCount = _c[1];
    ...
    var internalConnectRef = useRef(null);
    ...
    var _d = __read(useReducer(stateReducer, {
        titleId: null,
        descriptionId: null,
        buttonRef: buttonRef,
        walletState: WalletStates.NotConnected,
    }), 2), state = _d[0], dispatch = _d[1];
    var _e = useWeb3React(), active = _e.active, account = _e.account;
    var close = useCallback(function () { return onClose(false); }, [onClose]);
    var setTitleId = useCallback(function (id) { return dispatch({ type: ActionTypes.SetTitleId, id: id }); }, [dispatch]);
    var ready = useServerHandoffComplete();
    var enabled = ready
        ? __demoMode
            ? false
    ...
    var hasParentConnect = useContext(ConnectContext) !== null;
    ...
    var contextBag = useMemo(function () { return [{ connectState: connectState, close: close, setTitleId: setTitleId }, state, dispatch]; }, [connectState, state, close, setTitleId]);
    var slot = useMemo(function () { return ({
    ...
    return (React__default.createElement(StackProvider, { type: "Connect", element: internalConnectRef, onUpdate: useCallback(function (message, type, element) {
            var _a;
            if (type !== "Connect")
                return;
            match(message, (_a = {},
        ...
        React__default.createElement(ForcePortalRoot, { force: true },
            React__default.createElement(Portal, null,
                React__default.createElement(ConnectContext.Provider, { value: contextBag },
                    React__default.createElement(Portal.Group, { target: internalConnectRef },
                        React__default.createElement(ForcePortalRoot, { force: false },
                            React__default.createElement(DescriptionProvider, { slot: slot, name: "Connect.Description" }, render({
                                props: __assign(__assign({}, passthroughProps), propsWeControl),
                                slot: slot,
...
var Overlay = forwardRefWithAs(function Overlay(props, ref) {
    ...
    var slot = useMemo(function () { return ({ open: connectState === ConnectStates.Open }); }, [connectState]);
    var propsWeControl = {
        ref: overlayRef,
        id: id,
        "aria-hidden": true,
...
var MetamaskButton = forwardRefWithAs(function Button(props, ref) {
    ...
    var _c = useWeb3React(), active = _c.active, activate = _c.activate, account = _c.account;
...
function useENSName(provider, account) {
    var _this = this;
    var _a = __read(useState(), 2), ENSName = _a[0], setENSName = _a[1];
    useMemo(function () { return __awaiter(_this, void 0, void 0, function () {
        var name_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var MetamaskIcon = function (props) {
    return (React__default.createElement("svg", __assign({ width: "102", height: "94", viewBox: "0 0 102 94", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default.createElement("path", { d: "M96.0543 1L56.9893 29.9054L64.2537 12.8705L96.0543 1Z", fill: "#E17726", stroke: "#E17726", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M5.94583 1L44.6631 30.1751L37.7466 12.8705L5.94583 1Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M81.9884 68.0216L71.5944 83.9003L93.8509 90.0283L100.227 68.3687L81.9884 68.0216Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M1.81111 68.3687L8.14802 90.0283L30.3661 83.9003L20.0105 68.0216L1.81111 68.3687Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M29.168 41.1977L22.9857 50.5245L45.0104 51.5266L44.2764 27.8242L29.168 41.1977Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M72.8308 41.198L57.491 27.5547L56.9887 51.5269L79.0132 50.5248L72.8308 41.198Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M30.3664 83.9003L43.697 77.4642L32.2212 68.5228L30.3664 83.9003Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M58.303 77.4642L71.595 83.9003L69.7788 68.5228L58.303 77.4642Z", fill: "#E27625", stroke: "#E27625", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M71.595 83.9009L58.303 77.4648L59.3848 86.0977L59.2688 89.7591L71.595 83.9009Z", fill: "#D5BFB2", stroke: "#D5BFB2", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M30.3664 83.9009L42.7313 89.7591L42.6539 86.0977L43.697 77.4648L30.3664 83.9009Z", fill: "#D5BFB2", stroke: "#D5BFB2", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M42.9627 62.8189L31.9116 59.5816L39.7168 55.9973L42.9627 62.8189Z", fill: "#233447", stroke: "#233447", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M59.037 62.8189L62.2829 55.9973L70.1268 59.5816L59.037 62.8189Z", fill: "#233447", stroke: "#233447", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M30.3661 83.9003L32.2982 68.0216L20.0107 68.3687L30.3661 83.9003Z", fill: "#CC6228", stroke: "#CC6228", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M69.7012 68.0216L71.5946 83.9003L81.9887 68.3687L69.7012 68.0216Z", fill: "#CC6228", stroke: "#CC6228", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M79.0132 50.5243L56.9887 51.5263L59.0365 62.8189L62.2824 55.997L70.1262 59.5814L79.0132 50.5243Z", fill: "#CC6228", stroke: "#CC6228", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M31.9115 59.5814L39.7167 55.997L42.9626 62.8189L45.0104 51.5263L22.9857 50.5243L31.9115 59.5814Z", fill: "#CC6228", stroke: "#CC6228", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M22.9865 50.5243L32.2215 68.5228L31.9121 59.5814L22.9865 50.5243Z", fill: "#E27525", stroke: "#E27525", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M70.1268 59.5814L69.7791 68.5228L79.0141 50.5243L70.1268 59.5814Z", fill: "#E27525", stroke: "#E27525", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M45.0116 51.5263L42.9635 62.8189L45.5524 76.1537L46.1321 58.5793L45.0116 51.5263Z", fill: "#E27525", stroke: "#E27525", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M56.9893 51.5263L55.9072 58.5409L56.4482 76.1537L59.0371 62.8189L56.9893 51.5263Z", fill: "#E27525", stroke: "#E27525", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M59.0371 62.8192L56.4482 76.154L58.303 77.4645L69.7791 68.5231L70.1268 59.5817L59.0371 62.8192Z", fill: "#F5841F", stroke: "#F5841F", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M31.9116 59.5817L32.2209 68.5231L43.6967 77.4645L45.5515 76.154L42.9627 62.8192L31.9116 59.5817Z", fill: "#F5841F", stroke: "#F5841F", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M59.2691 89.7588L59.3848 86.0975L58.3804 85.2495H43.62L42.6539 86.0975L42.7313 89.7588L30.3664 83.9006L34.694 87.4463L43.4653 93.4973H58.496L67.306 87.4463L71.595 83.9006L59.2691 89.7588Z", fill: "#C0AC9D", stroke: "#C0AC9D", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M58.3027 77.4642L56.4479 76.154H45.5515L43.697 77.4642L42.6536 86.0974L43.6196 85.2495H58.38L59.3847 86.0974L58.3027 77.4642Z", fill: "#161616", stroke: "#161616", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M97.7155 31.7938L101 15.8381L96.054 1L58.303 28.942L72.8314 41.1977L93.3492 47.1716L97.8701 41.8916L95.8996 40.4654L99.0292 37.6136L96.6337 35.7636L99.7636 33.374L97.7155 31.7938Z", fill: "#763E1A", stroke: "#763E1A", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M1 15.8381L4.32303 31.7938L2.19785 33.374L5.36631 35.7636L2.97064 37.6136L6.10046 40.4654L4.12982 41.8916L8.6507 47.1716L29.1686 41.1977L43.697 28.942L5.94591 1L1 15.8381Z", fill: "#763E1A", stroke: "#763E1A", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M93.3494 47.1713L72.8317 41.1976L79.0141 50.5245L69.7791 68.5227L81.9893 68.3687H100.227L93.3494 47.1713Z", fill: "#F5841F", stroke: "#F5841F", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M29.168 41.1976L8.65036 47.1713L1.81111 68.3687H20.0105L32.2206 68.5227L22.9858 50.5245L29.168 41.1976Z", fill: "#F5841F", stroke: "#F5841F", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" }),
        React__default.createElement("path", { d: "M56.9889 51.5266L58.3027 28.9417L64.2531 12.8704H37.7462L43.6967 28.9417L45.0104 51.5266L45.5128 58.618L45.5515 76.154H56.4479L56.4866 58.618L56.9889 51.5266Z", fill: "#F5841F", stroke: "#F5841F", strokeWidth: "0.25", strokeLinecap: "round", strokeLinejoin: "round" })));
};
var WalletConnectIcon = function (props) {
    return (React__default.createElement("svg", __assign({ width: "100", height: "62", viewBox: "0 0 100 62", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React__default.createElement("path", { d: "M20.4721 11.9751C36.7799 -3.99169 63.2202 -3.99169 79.528 11.9751L81.4907 13.8967C82.3061 14.695 82.3061 15.9894 81.4907 16.7877L74.7768 23.3612C74.3691 23.7604 73.7081 23.7604 73.3004 23.3612L70.5995 20.7168C59.2227 9.57802 40.7774 9.57802 29.4006 20.7168L26.5082 23.5487C26.1005 23.9479 25.4395 23.9479 25.0318 23.5487L18.3179 16.9753C17.5025 16.1769 17.5025 14.8826 18.3179 14.0842L20.4721 11.9751ZM93.4131 25.5697L99.3885 31.4202C100.204 32.2185 100.204 33.5129 99.3885 34.3112L72.445 60.6916C71.6296 61.4899 70.3076 61.4899 69.4922 60.6916C69.4922 60.6916 69.4922 60.6916 69.4921 60.6916L50.3693 41.9687C50.1654 41.7691 49.8349 41.7691 49.6311 41.9687C49.6311 41.9687 49.6311 41.9687 49.6311 41.9687L30.5086 60.6916C29.6932 61.4899 28.3712 61.4899 27.5558 60.6916C27.5558 60.6916 27.5558 60.6916 27.5558 60.6916L0.611544 34.3109C-0.203848 33.5125 -0.203848 32.2182 0.611544 31.4198L6.58696 25.5694C7.40235 24.7711 8.72436 24.7711 9.53976 25.5694L28.6629 44.2926C28.8667 44.4922 29.1973 44.4922 29.4011 44.2926C29.4011 44.2926 29.4011 44.2926 29.4011 44.2926L48.5233 25.5694C49.3387 24.771 50.6607 24.771 51.4761 25.5693C51.4761 25.5693 51.4761 25.5694 51.4761 25.5694L70.5992 44.2926C70.8031 44.4921 71.1336 44.4921 71.3374 44.2926L90.4603 25.5697C91.2757 24.7714 92.5977 24.7714 93.4131 25.5697Z", fill: "#3B99FC" })));
};
...
var ConnectButton = function () {
    useConnectedWallet();
    var _a = useWeb3React(), account = _a.account, active = _a.active, library = _a.library;
    ...
    return (React__default.createElement(React__default.Fragment, null,
        React__default.createElement("div", { className: "" },
            React__default.createElement("button", { type: "button", onClick: openModal, className: "px-4 py-2 text-sm font-medium text-white bg-primary rounded-md bg-opacity-80 hover:bg-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75" },
                active && account && ensName,
                !account && "Connect Wallet",
                active && account && !ensName && trimAccount(account))),
        React__default.createElement(AnimatePresence, null, isOpen && (React__default.createElement(Connect, { static: true, as: "div", open: isOpen, className: "fixed inset-0 z-10 overflow-y-auto", onClose: closeModal }, function (_a) {
            var connected = _a.connected, connecting = _a.connecting;
            return (React__default.createElement("div", { className: "min-h-screen px-4 text-center" },
                React__default.createElement(Connect.Overlay, { className: "fixed inset-0 bg-black bg-opacity-50" }),
                React__default.createElement("span", { className: "inline-block h-screen align-middle", "aria-hidden": "true" }, "\u200B"),
                React__default.createElement("div", { className: "inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl" },
                    ...
                    React__default.createElement("div", { className: "mt-4 flex flex-col gap-y-3" },
                        !connected && !connecting && (React__default.createElement(React__default.Fragment, null,
                            React__default.createElement(Connect.MetamaskButton, { className: "flex items-center px-4 py-2 text-sm font-medium border text-left border-transparent rounded-md hover:border-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary" },
                                React__default.createElement(React__default.Fragment, null,
                                    React__default.createElement(MetamaskIcon, { className: "h-10 w-10 mr-4" }),
                                    !connected && React__default.createElement("span", null, "Connect With Metamask"),
                                    connecting && React__default.createElement("span", null, "Connecting..."))),
                            React__default.createElement(Connect.WalletConnectButton, { className: "flex items-center px-4 py-2 text-sm font-medium text-left border border-transparent rounded-md hover:border-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-primary" },
                                React__default.createElement(React__default.Fragment, null,
                        ...
                        connecting && (React__default.createElement("div", { className: "flex items-center justify-center h-20" },
...
export { ChainSwitcher, ConnectButton, Icon };
