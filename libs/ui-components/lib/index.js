        ...
        React__default["default"].createElement(AnimatePresence, null, isOpen && (React__default["default"].createElement(Connect, { static: true, as: "div", open: isOpen, className: "fixed inset-0 z-10 overflow-y-auto", onClose: closeModal }, function (_a) {
            ...
            return (React__default["default"].createElement("div", { className: "min-h-screen px-4 text-center" },
                ...
                React__default["default"].createElement("div", { className: "inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl" },
                    ...
                    React__default["default"].createElement("button", { className: "absolute top-5 right-5", onClick: closeModal },
                        React__default["default"].createElement(Icon, { className: "fill-primary", icon: "close" })),
                    React__default["default"].createElement("div", { className: "mt-4 flex flex-col gap-y-3" },
                        ...
                        (waiting || connecting) && (React__default["default"].createElement("div", { className: "flex items-center justify-center h-20" },
                            React__default["default"].createElement(Rotate, null))),
                        connected && account && (React__default["default"].createElement("div", { className: "flex px-2 py-4 border rounded-md border-primary justify-between" },
                            React__default["default"].createElement("div", null,
                                React__default["default"].createElement("p", { className: "text-md font-medium" }, trimAccount(account))),
                            React__default["default"].createElement(Connect.DisconnectButton, { className: "px-2 py-1 text-xs font-medium text-white bg-primary rounded-md bg-opacity-80 hover:bg-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75" }, "Disconnect")))))));
        })))));
};
