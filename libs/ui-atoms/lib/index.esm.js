...
var Logo = function (_a) {
    ...
    return (React.createElement("div", { className: "text-blue-300" },
        React.createElement("img", { className: logoClasses(size), src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNKBCUqHqXhzWXIp0jkhMKP3w4mUz2CgbkRw&usqp=CAU" })));
};
var LogoIcon = function (_a) {
    var size = _a.size;
    return (React.createElement("div", { className: logoClasses(size) + " text-blue-300" },
        React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 841.9 595.3" },
