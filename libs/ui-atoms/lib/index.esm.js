...
var Logo = function (_a) {
    var size = _a.size;
    return (React.createElement("div", { className: "text-blue-300" },
        React.createElement("img", { className: size, src: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSNKBCUqHqXhzWXIp0jkhMKP3w4mUz2CgbkRw&usqp=CAU" })));
};
Logo.protoTypes = {
