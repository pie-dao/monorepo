...
import type {
  PievaultAbi,
  PievaultAbiInterface,
} from '../../pie-vault/PievaultAbi';
...
export class PievaultAbi__factory {
  static readonly abi = _abi;
  static createInterface(): PievaultAbiInterface {
    return new utils.Interface(_abi) as PievaultAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): PievaultAbi {
    return new Contract(address, _abi, signerOrProvider) as PievaultAbi;
  }
}
