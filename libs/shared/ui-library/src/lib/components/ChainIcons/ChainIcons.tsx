...
export const EthereumIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <path fill="currentColor" d="m9 16 7-12 7.5 12-7.5 4-7-4Z" />
    <path fill="currentColor" d="m9 17.5 7 4 7.5-4L16 28 9 17.5Z" />
  </svg>
);

export const FantomIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 32 32"
